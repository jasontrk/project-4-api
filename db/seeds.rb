...
users = User.create!([
  ...
  Medium.create!([{
    ...
    poster_path: "https://image.tmdb.org/t/p/w92/rjUl3pd1LHVOVfG4IGcyA1cId5l.jpg",
    ...
    poster_path: "https://image.tmdb.org/t/p/w92/ApYhuwBWzl29Oxe9JJsgL7qILbD.jpg",
    genre_ids: [878, 28, 12],
    creator: users[0]
    },{
    ...
    poster_path: "https://image.tmdb.org/t/p/w92/uX7LXnsC7bZJZjn048UCOwkPXWJ.jpg",
    ...
    poster_path: "https://image.tmdb.org/t/p/w92/syPWyeeqzTQIxjIUaIFI7d0TyEY.jpg",
    genre_ids: [10751, 16],
    creator: users[1]
  },{
    ...
    poster_path: "https://image.tmdb.org/t/p/w92/1SwAVYpuLj8KsHxllTF8Dt9dSSX.jpg",
    ...
    poster_path: "https://image.tmdb.org/t/p/w92/9fgh3Ns1iRzlQNYuJyK0ARQZU7w.jpg",
    genre_ids: [53, 27],
    creator: users[2]
  },{
    ...
    poster_path: "https://image.tmdb.org/t/p/w92/bbxtz5V0vvnTDA2qWbiiRC77Ok9.jpg",
    genre_ids: [27],
    creator: users[2]
  },{
    name: "Beauty and the Beast", release_date: Date.new(2017, 3, 16),
    overview: "A live-action adaptation of Disney's version of the classic 'Beauty and the Beast' tale of a cursed prince and a beautiful young woman who helps him break the spell.",
    poster_path: "https://image.tmdb.org/t/p/w92/tWqifoYuwLETmmasnGHO7xBjEtt.jpg",
    ...
    poster_path: "https://image.tmdb.org/t/p/w92/ylXCdC106IKiarftHkcacasaAcb.jpg",
    ...
    poster_path: "https://image.tmdb.org/t/p/w92/fsoTLnUXEUTNuVCBxAJMY0HPPd.jpg",
    ...
    poster_path: "https://image.tmdb.org/t/p/w92/oXUWEc5i3wYyFnL1Ycu8ppxxPvs.jpg",
    genre_ids: [37, 18, 12, 53],
    creator: users[4]
  },{
    name: "Django Unchained", release_date: Date.new(2013, 12, 18),
    overview: "With the help of a German bounty hunter, a freed slave sets out to rescue his wife from a brutal Mississippi plantation owner.",
    poster_path: "https://image.tmdb.org/t/p/w92/5WJnxuw41sddupf8cwOxYftuvJG.jpg",
    genre_ids: [37, 18],
    creator: users[4]
  },{
    ...
    poster_path: "https://image.tmdb.org/t/p/w92/6YOrNBdoXvT8aC5VPLkkN6t5z0V.jpg",
